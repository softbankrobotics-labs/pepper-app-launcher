package com.softbankrobotics.pepperapplauncher.Utils;
...
public class ChatData {
    ...
    public List<String> topicNames= Collections.singletonList("topic");
    ...
    private final com.aldebaran.qi.sdk.object.locale.Locale qiLocale;
     ...
     * @param topicContent the names of the .top file you want to use in this chat bot
    ...
    public ChatData(Activity activity, QiContext qiContext, Locale locale,
                    List<String> topicContent, Boolean buildChat) {
        ...
        if (isLanguageAvailable(qiLocale, qiContext)) {
            ...
            if (!config.locale.toString().contains(locale.toString())) {
            ...
            for(String content : topicContent){
    ...
    private boolean isLanguageAvailable(com.aldebaran.qi.sdk.object.locale.Locale locale, QiContext qiContext) {
        ...
        try {
            ...
            if (e.getMessage().contains("language is not installed.") || e.getMessage().contains("is not supported.")) {
                return false;
            } else {
                throw e;
            }
